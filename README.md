...
bash ~/vibeguard/setup.sh --profile strict            # Strict: full hooks + U-32 SessionStart constraint budget
...
| `strict` | full + count-active-constraints (SessionStart/U-32) | Maximum enforcement |
